...
let totalTickets = total / singleTicket;

console.log("total tickets sold==>" + totalTickets + " " + "dollars");

// Q2. Sylvia's income is 500 dollars per week. How much does Sylvia makes every year?

let incomeWeekly = 500;
let weeksYear = 52;

let incomeYear = incomeWeekly * weeksYear;

console.log("total income/year==>" + incomeYear + " " + "dollars");
...
let perimeter1 = l1 + l2 + l3;
console.log("perimeter1 ==>" + perimeter1 + " " + "cm");
// Q6. Calculate the area of a square. Each side is 5cm.

let side1 = 5;

let areaSquare = side1 * side1;

console.log("areaSquare ==>" + areaSquare + " " + "cm2");
